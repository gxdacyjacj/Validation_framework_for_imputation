...
def block_output_path(
    dataset_id: int, dataset_name: str, mask_name: str, rate: float, out_root: str
) -> str:
...
def main():
    ...
    # -------------------------------------------------------------
    # 2) Enumerate all 6 x 6 = 36 blocks and check which are done
    # -------------------------------------------------------------
    ...
    if not remaining_blocks:
        print("\nAll 36 blocks for this dataset are already done. Nothing to run.")
        return
